  ...
  return (
    <div className="flex items-start gap-3 w-full max-w-sm mx-auto mb-8 animate-bounce-slow">
      <div className="relative bg-white  px-5 py-3 rounded-2xl shadow-lg border border-primary/10 flex-1">
        ...
        <div className="absolute -bottom-2 right-6 w-4 h-4 bg-white  rotate-45 border-b border-r border-primary/10"></div>
      </div>
      <div className="size-16 rounded-full bg-primary/20 flex items-center justify-center overflow-hidden border-2 border-white  shadow-md shrink-0">
        <img
