...
import type { QuestionType, ClockTime } from "./types";
    ...
    <div className="flex flex-col min-h-screen max-w-md mx-auto bg-background-light relative overflow-hidden">
      ...
      <header className="px-6 pt-10 pb-4">
        <div className="flex items-center justify-between mb-6">
          <button className="flex items-center justify-center size-10 rounded-full bg-white  shadow-sm border border-slate-200  active:scale-90 transition-transform">
