    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#121220] p-4 text-white">
            <header className="mb-10 text-center">
                ...
                <p className="text-l tracking-tighter text-gray-200">
            ...
            <footer className="mt-14 text-center">
                <button
                    onClick={handleMeow}
                    className="cursor-pointer border-b-4 border-[#9A3412] bg-[#EA580C] px-8 py-4 text-xl font-bold text-white transition-all hover:bg-[#F97316] active:translate-y-1 active:border-b-0"
                >
                    SAY HI
                </button>
