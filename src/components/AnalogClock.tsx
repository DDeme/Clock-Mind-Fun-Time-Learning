...
const AnalogClock: React.FC<AnalogClockProps> = ({
  ...
  return (
    <div
      className="relative rounded-full border-[10px] border-white  bg-white  clock-shadow flex items-center justify-center transition-all duration-500 ease-in-out"
    ...
    >
      ...
      <div className="absolute inset-4 text-slate-400 font-extrabold text-lg select-none">
        ...
        <span className="absolute top-[10%] right-[22%] text-sm opacity-30">
          1
        </span>
        <span className="absolute top-[25%] right-[8%] text-sm opacity-30">
          2
        </span>
        <span className="absolute bottom-[25%] right-[8%] text-sm opacity-30">
          4
        </span>
        <span className="absolute bottom-[10%] right-[22%] text-sm opacity-30">
          5
        </span>
        <span className="absolute bottom-[10%] left-[22%] text-sm opacity-30">
          7
        </span>
        <span className="absolute bottom-[25%] left-[8%] text-sm opacity-30">
          8
        </span>
        <span className="absolute top-[25%] left-[8%] text-sm opacity-30">
          10
        </span>
        <span className="absolute top-[10%] left-[22%] text-sm opacity-30">
          11
        </span>
      </div>
      ...
      <div className="relative w-full h-full flex items-center justify-center">
        ...
        {/* Hour Hand */}
        <div
          className="absolute w-2.5 rounded-full bg-slate-800  origin-bottom transition-transform duration-700 ease-out"
          style={{
            height: size * 0.25,
